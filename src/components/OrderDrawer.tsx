        ...
        <div className="fixed inset-0 z-50 overflow-hidden">
          ...
          <div className="fixed inset-y-0 right-0 max-w-full flex pl-0 sm:pl-10">
            ...
            <motion.div
              ...
              className="w-full sm:w-screen max-w-md bg-[#121316] border-l border-[#252830] text-[#f4efe6] shadow-2xl flex flex-col h-full"
            >
              {/* Header */}
              ...
              {cart.length > 0 && (
                <div className="p-4 sm:p-5 pb-[max(1.25rem,env(safe-area-inset-bottom))] bg-[#16181d] border-t border-[#252830] space-y-3 flex-shrink-0">
                  ...
                  <motion.button
                    ...
                    className="w-full py-4 px-4 rounded-xl bg-gradient-to-r from-[#22c55e] to-[#16a34a] hover:from-[#16a34a] hover:to-[#15803d] text-white font-heading font-bold text-sm tracking-wide shadow-lg shadow-[#22c55e]/20 flex items-center justify-center gap-2 transition-all group min-h-[48px]"
                  >
