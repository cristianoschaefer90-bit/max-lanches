...
export const LocationSection: React.FC = () => {
  ...
  return (
    <section id="localizacao" className="py-20 lg:py-28 relative bg-[#0b0c0e] border-t border-[#1a1c22]">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-12">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-stretch">
          ...
          <div className="lg:col-span-6 space-y-6 flex flex-col justify-between">
            ...
            {/* Address Card */}
            <div className="p-6 sm:p-7 rounded-2xl bg-[#14161c] border border-[#232731] space-y-4">
            ...
            <div className="grid grid-cols-3 gap-3 text-center">
              <div className="p-3 rounded-xl bg-[#14161c] border border-[#232731] space-y-1">
          ...
          {/* Right Column: Google Maps Visual Embed */}
          <div className="lg:col-span-6 relative rounded-2xl overflow-hidden border border-[#272b35] bg-[#14161c] min-h-[380px] shadow-2xl flex flex-col">
            <iframe
